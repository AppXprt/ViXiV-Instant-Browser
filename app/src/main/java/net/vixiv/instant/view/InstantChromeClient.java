...
import net.vixiv.instant.favicon.FaviconModel;
import net.vixiv.instant.utils.Preconditions;

public class InstantChromeClient extends WebChromeClient {
    ...
    InstantChromeClient(@NonNull Activity activity, @NonNull InstantView instantView) {
    ...
    public void onReceivedIcon(@NonNull WebView view, Bitmap icon) {
        mInstantView.getTitleInfo().setFavicon(icon);
    ...
    public void onReceivedTitle(@Nullable WebView view, @Nullable String title) {
        if (title != null && !title.isEmpty()) {
            mInstantView.getTitleInfo().setTitle(title);
        } else {
    ...
    public void onCloseWindow(WebView window) {
        mUIController.onCloseWindow(mInstantView);
    }
    ...
    /**
     * Inflate a view to send to a InstantView when it needs to display a video and has to
