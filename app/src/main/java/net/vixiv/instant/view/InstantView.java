...
package net.vixiv.instant.view;
...
/**
 * {@link InstantView} acts as a tab for the browser,
...
public class InstantView {
    ...
    @NonNull private final InstantViewTitle mTitle;
    ...
    @Inject InstantDialogBuilder mDialogBuilder;
    @Inject ProxyUtils mProxyUtils;

    public InstantView(@NonNull Activity activity, @Nullable String url, boolean isIncognito) {
        ...
        mTitle = new InstantViewTitle(activity);
        ...
        mWebView.setWebChromeClient(new InstantChromeClient(activity, this));
        mWebView.setWebViewClient(new InstantWebClient(activity, this));
        mWebView.setDownloadListener(new InstantDownloadListener(activity));
    ...
    /**
     * Initialize the settings of the WebView that are intrinsic to Instant and cannot
    ...
    /**
     * Getter for the {@link InstantViewTitle} of the
     * current InstantView instance.
     *
     * @return a NonNull instance of InstantViewTitle
     */
    @NonNull
    public InstantViewTitle getTitleInfo() {
        return mTitle;
    }
    ...
    /**
     * Notify the InstantView that there is low memory and
     ...
     * of the current InstantView and makes the CPU render
     * the view.
     */
     ...
     * of the current InstantView. The for modes are normal
     ...
     * instance of the InstantView is useless as
     ...
     * only have an affect after {@link InstantView#find(String)}
     ...
     * {@link InstantView#find(String)} has been called.
    ...
    private static class WebViewHandler extends Handler {
        ...
        @NonNull private final WeakReference<InstantView> mReference;

        WebViewHandler(@NonNull InstantView view) {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            InstantView view = mReference.get();
            if (view != null) {
