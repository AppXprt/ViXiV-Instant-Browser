 ...
 */
package net.vixiv.instant.download;
...
import net.vixiv.instant.MainActivity;
...
import net.vixiv.instant.database.downloads.DownloadItem;
...
public class DownloadHandler {
    ...
    private void onDownloadStartNoStream(@NonNull final Activity context, @NonNull PreferenceManager preferences,
        ...
        InstantView view = browserActivity.getTabModel().getCurrentTab();
