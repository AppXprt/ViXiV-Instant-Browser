...
public class InstantDownloadListener implements DownloadListener {

    private static final String TAG = "InstantDownloader";
    ...
    public InstantDownloadListener(Activity context) {
