...
import net.vixiv.instant.browser.fragment.anim.HorizontalItemAnimator;
import net.vixiv.instant.browser.fragment.anim.VerticalItemAnimator;
...
import net.vixiv.instant.view.BackgroundDrawable;
...
public class TabsFragment extends Fragment implements View.OnClickListener, View.OnLongClickListener, TabsView {
    ...
    @Nullable private InstantViewAdapter mTabsAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mTabsAdapter = new InstantViewAdapter(mShowInNavigationDrawer);
    ...
    private class InstantViewAdapter extends RecyclerView.Adapter<InstantViewAdapter.InstantViewHolder> {
        ...
        public InstantViewAdapter(final boolean vertical) {
        ...
        @NonNull
        @Override
        public InstantViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        @Override
        public void onBindViewHolder(@NonNull final InstantViewHolder holder, int position) {
            holder.exitButton.setTag(position);

            ViewCompat.jumpDrawablesToCurrentState(holder.exitButton);

            InstantView web = getTabsManager().getTabAtPosition(position);
            if (web == null) {
                return;
            }
        ...
        public class InstantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {

            public InstantViewHolder(@NonNull View view) {
                super(view);
