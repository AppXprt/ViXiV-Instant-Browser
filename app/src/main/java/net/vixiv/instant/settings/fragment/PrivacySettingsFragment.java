...
public class PrivacySettingsFragment extends InstantPreferenceFragment implements Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
    ...
    private void initPrefs() {
        ...
        String identifyingHeadersSummary = InstantView.HEADER_REQUESTED_WITH + ", " + InstantView.HEADER_WAP_PROFILE;
